...
- [x] **MANUAL (post-publish, developer action):** after tagging + pushing v0.16.0 and `publish.yml` succeeds, verify `pip install ml-datarefinery==0.16.0` in a clean venv resolves matplotlib + the `[corruptions]` extras cleanly.
